...
impl Config for Small {
    fn prime() -> &'static str {
        "27384083395425770033880312552185387014657"
    }
    fn n() -> usize {
        256
    }
    ...
    fn omega_n() -> &'static str {
        "11760837463486371896102955950879363236841"
    }
    fn omega_m() -> &'static str {
        "282515243551697216317750839613713827799"
    }
}
...
impl Config for Medium {
    fn prime() -> &'static str {
        "11957119570273711187856305448866671914241"
    }
    fn n() -> usize {
        256
    }
    ...
    fn omega_n() -> &'static str {
        "3069700116802786132417224549683499080751"
    }
    fn omega_m() -> &'static str {
        "4240725152029417998256133660574413855628"
    }
}
...
impl Config for Large {
    fn prime() -> &'static str {
        "2168493841578655774908481580141050902529"
    }
    fn n() -> usize {
        1024
    }
    ...
    fn omega_n() -> &'static str {
        "575568907032575917226189174489221138041"
    }
    fn omega_m() -> &'static str {
        "611000397685398983853362438068827993522"
    }
}
